<%@ page language="java" import="com.enoo.quiz.*" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
...
<script language ="javascript" >
        ...
        function examTimer() {
            if (parseInt(sec) >0) {
			    ...
			    document.getElementById("showtime").innerHTML = "남은 시간 : "+min+"분 " + sec+"조";
                sec = parseInt(sec) - 1;                
...
<%
 ...
 %>
문제 ${sessionScope.quest.questionNumber} / ${sessionScope.totalNumberOfQuizQuestions}
</div>
...
<form action="exam" method="post" name="questionForm" >
 ...
 <c:if test="${sessionScope.quest.questionNumber < sessionScope.totalNumberOfQuizQuestions}">
